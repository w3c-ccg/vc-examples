...
describe("cmtr-v0.0", () => {
    describe("issue and verify verifiableCredentialSchema", () => {
        ...
        it("should pass when verifiableCredentialSchema is not mutated", async () => {
            ...
            fs.writeFileSync(path.resolve(__dirname, './examples/v0.0/cmtr-verifiable-credential-schema-v0.0.json'), JSON.stringify(verifiableCredentialSchema, null, 2))
            const result = await jsigs.verify(verifiableCredentialSchema, {
                documentLoader,
                suite,
                purpose: new AssertionProofPurpose({})
    ...
    describe("issue and verify verifiableCredential",  () => {
        ...
        it("should pass when verifiableCredential is not mutated ", async () => {
            ...
            fs.writeFileSync(path.resolve(__dirname, './examples/v0.0/cmtr-verifiable-credential-v0.0.json'), JSON.stringify(verifiableCredential, null, 2))
